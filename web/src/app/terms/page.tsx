export default function TermsPage() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-12">
      <h1 className="text-3xl font-bold">Terms of Service and Code of Conduct</h1>
      <p className="mt-2 text-sm text-gray-500">Placeholder — final copy pending legal review.</p>
      ...
      <section className="prose mt-8 max-w-none">
        ...
        <h2 className="mt-6 text-xl font-semibold">4. Code of Conduct</h2>
        ...
        <h2 className="mt-6 text-xl font-semibold">6. Data</h2>
        <p>
