  ...
  return (
    <main className="mx-auto max-w-container-wide px-8 pb-24 pt-12">
      ...
      <section className="mt-8 space-y-6 text-ink leading-relaxed">
        <div>
          <h2 className="font-serif text-xl text-ink">1. Acceptance</h2>
          <p className="mt-2">
        ...
        <div>
          <h2 className="font-serif text-xl text-ink">2. Eligibility</h2>
          <p className="mt-2">
        ...
        <div>
          <h2 className="font-serif text-xl text-ink">3. Payments</h2>
          <p className="mt-2">
        ...
        <div>
          <h2 className="font-serif text-xl text-ink">4. Code of Conduct</h2>
        ...
        <div>
          <h2 className="font-serif text-xl text-ink">5. Disputes</h2>
          <p className="mt-2">
        ...
        <div>
          <h2 className="font-serif text-xl text-ink">6. Data</h2>
          <p className="mt-2">
